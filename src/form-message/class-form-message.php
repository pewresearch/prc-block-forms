...
class Form_Message {
	/**
	 * Form message bindings editor script manifest.
	 *
	...
	/**
	 * Editor script handle for form message bindings registration.
	 *
	 * @var string|false
	 */
	...
	public function __construct( $loader ) {
		$this->bindings_block_json = \prc_block_forms_manifest( 'form-message-bindings' );
		$this->init( $loader );
	}
	...
	/**
	 * Enqueue form message binding registration in every block editor context.
	 *
	...
	public function block_init() {
		register_block_type_from_metadata(
			PRC_BLOCK_FORMS_DIR . '/build/form-message',
			array(
